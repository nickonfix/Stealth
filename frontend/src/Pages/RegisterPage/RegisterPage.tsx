      ...
      <div className="lp-root">
        ...
        <div className="lp-center">
          ...
          <div className="lp-card">
            ...
            <h1 className="lp-head">Create <em>account</em></h1>
            <p className="lp-sub">Join TradeFolio to start tracking your assets.</p>
            ...
            <p className="lp-signup">
              ...
              <Link to="/login" style={{ color: '#10b981', fontWeight: 500, textDecoration: 'none' }} onMouseEnter={e => e.currentTarget.style.textDecoration='underline'} onMouseLeave={e => e.currentTarget.style.textDecoration='none'}>Sign in</Link>
            </p>
          </div>
