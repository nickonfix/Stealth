...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: "forgot-password", element: <PlaceholderPage title="Reset Password" subtitle="Enter your email to receive a password reset link. Security and recovery options are coming soon." icon="🔑" /> },
