...
export interface CompanyIncomeStatement {
    ...
    cik: string;
    filingDate: string; // fixed spelling
    acceptedDate: string;
    fiscalYear: string; // API uses fiscalYear, not calendarYear
    period: string;
    ...
    netInterestIncome: number; // present in API
    ...
    ebitda: number;
    ebit: number; // missing in your version
